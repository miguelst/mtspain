 ...
 * on Thu, 01 Sep 2016 11:10:51 +0000.
 *
...
if (isset($_SERVER['db_name'])) {
  ...
  */
  ...
  $conf['file_public_path'] = 'sites/mtspain.net/files';
  $conf['file_temporary_path'] = 'sites/mtspain.net/private/temp';
  $conf['file_private_path'] = 'sites/mtspain.net/private/files';
  $drupal_hash_salt = '';
  $conf['clean_url'] = 1;
  $conf['aegir_api'] = 3;
...
# Extra configuration from modules:
  ...
  if (is_readable('/data/disk/o5290590944/config/includes/global.inc')) {
    include_once('/data/disk/o5290590944/config/includes/global.inc');
  }

  # Additional site configuration settings.
  if (is_readable('/data/disk/o5290590944/distro/032/drupal-7.50.1-dev/sites/mtspain.net/local.settings.php')) {
    include_once('/data/disk/o5290590944/distro/032/drupal-7.50.1-dev/sites/mtspain.net/local.settings.php');
  }
